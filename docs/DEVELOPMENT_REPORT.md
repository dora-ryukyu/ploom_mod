...
> **現在の検証ステータス:** SuperLong **v7** — 時間は v6（~10 min 狙い / 695s）、温度を大幅アップ（予熱 **320**・台 **280**・後半 **300**）。後半パワー優先。失敗したら諦める前提の攻めた版。
...
| SuperLong | **v7 検証中** | 時間 v6（695s ~10 min）+ 温度 **320 / 280 / 300** |
...
時間は **v6 固定**。後半でも据えるよう加熱帯を攻める。

| step | 時間 (s) | v4/v6 °C | **v7 °C** |
|------|----------|----------|-----------|
| 00–02 予熱 | 80+35+25 | 310 | **320**（Eco 級） |
| 03 特殊 | 20 | −220 | **−220**（維持） |
| 04 遷移 | 15 | 231 | **255** |
| 05 長台 | **255** | 250 | **280** |
| 06 後半 | **250** | 260 | **300** |
...
失敗時は早期終了・焦げ・保護 transient があり得る。だめなら諦める前提。
...
| **D7** | SuperLong v7 高温（320/280/300） | **検証中** |
...
| `userHeatProfile/SuperLong.json` | **現行 v7** 定義 |
...
> **焼付は通る。255s/step 上限。v6 で ~10 分枠（695s）。現行 v7 はその時間のまま 320/280/300 の高温で後半パワーを狙う。**
