...
> **現在の検証ステータス:** SuperLong **v8** — 時間 v6（~10 min / 695s）。v7 は最後まで吸えるが **後半焦げ・味落ち**。実運用は味が死んだら途中キャンセル前提 → **維持→ゆるく下降**曲線（台 **265** → 後半 **255**）。再加熱しない一本使い。
...
| SuperLong | **v8 検証中** | ~10 min 枠 + **維持 265 → 下降 255**（v7 後半上昇は不採用） |
